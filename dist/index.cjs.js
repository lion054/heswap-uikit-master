...
var Icon$13 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 64 64" }, props),
        ...
        React__default['default'].createElement("defs", null,
            React__default['default'].createElement("linearGradient", { id: "paint0_linear_luckychips", x1: "25.691", y1: "9.6549", x2: "25.691", y2: "40.2608", gradientUnits: "userSpaceOnUse" },
...
var Icon$12 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React__default['default'].createElement("circle", { cx: "45", cy: "45", r: "45", fill: "url(#paint0_linear_luckychipround)" }),
        ...
        React__default['default'].createElement("defs", null,
            React__default['default'].createElement("linearGradient", { id: "paint0_linear_luckychipround", x1: "45", y1: "0", x2: "45", y2: "90", gradientUnits: "userSpaceOnUse" },
                React__default['default'].createElement("stop", { stopColor: "#54DADE" }),
                React__default['default'].createElement("stop", { offset: "0.762157", stopColor: "#24C7D6" })),
            React__default['default'].createElement("linearGradient", { id: "paint1_linear_luckychipround", x1: "38.7618", y1: "24.0704", x2: "38.7618", y2: "51.8948", gradientUnits: "userSpaceOnUse" },
                React__default['default'].createElement("stop", { stopColor: "#9F4A08" }),
                React__default['default'].createElement("stop", { offset: "0.370494", stopColor: "#7D3900" }),
                React__default['default'].createElement("stop", { offset: "1", stopColor: "#8D4104" })))));
};
...
var LuckyChipToggle = function (_a) {
    ...
    return (React__default['default'].createElement(LuckyChipStack, { scale: scale },
        React__default['default'].createElement(LuckyChipInput, __assign({ id: props.id || "luckychip-toggle", scale: scale, type: "checkbox", checked: checked }, props)),
        React__default['default'].createElement(LuckyChipLabel, { scale: scale, checked: checked, htmlFor: props.id || "luckychip-toggle" },
            React__default['default'].createElement("div", { className: "luckychips" },
                React__default['default'].createElement("div", { className: "luckychip" }),
                React__default['default'].createElement("div", { className: "luckychip" }),
                React__default['default'].createElement("div", { className: "luckychip" }),
...
var RotatingLuckyChipIcon = styled__default['default'](Icon$r)(templateObject_4$4 || (templateObject_4$4 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
...
var Spinner = function (_a) {
    ...
    return (React__default['default'].createElement(Container$3, null,
        React__default['default'].createElement(RotatingLuckyChipIcon, { width: size * 0.5 + "px" }),
...
var ModalCloseButton = function (_a) {
    ...
    var theme = styled.useTheme();
    return (React__default['default'].createElement(IconButton, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog", width: "24px", height: "24px" },
        React__default['default'].createElement(Icon$1g, { color: theme.modal.close })));
};
var ModalBackButton = function (_a) {
    var onBack = _a.onBack;
    return (React__default['default'].createElement(IconButton, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px", width: "24px", height: "24px" },
    ...
    return (React__default['default'].createElement(ModalContainer, __assign({ minWidth: minWidth }, props),
        React__default['default'].createElement(ModalHeader, { background: getThemeValue("colors." + headerBackground, headerBackground)(theme) },
            React__default['default'].createElement(ModalTitle, null,
                ...
                React__default['default'].createElement(Heading, { color: theme.colors.text }, title)),
...
var Icon$q = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "-4 -4 28 28" }, props),
        React__default['default'].createElement("g", { transform: "translate(-4, 20) scale(0.004687,-0.004687)" },
...
var Icon$p = function (props) { return (React__default['default'].createElement(Svg, __assign({ viewBox: "-4 -4 28 28" }, props),
    React__default['default'].createElement("g", { transform: "translate(-4, 20) scale(0.1, -0.1)" },
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://exchange.luckychip.finance/#/swap?outputCurrency=0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82", target: "_blank" },
...
var LangSelector = function (_a) {
    ...
    return (React__default['default'].createElement(Dropdown, { position: "top-right", target: React__default['default'].createElement(Button, { variant: "text", startIcon: React__default['default'].createElement(Icon$19, { color: "textSubtle", width: "24px" }) },
            React__default['default'].createElement(Text, { color: "textSubtle" }, currentLang === null || currentLang === void 0 ? void 0 : currentLang.toUpperCase())) }, langs.map(function (lang, index) { return (React__default['default'].createElement(MenuButton, { key: index.toString(), fullWidth: true, onClick: function () { return setLang(lang); }, 
        // Safari fix
...
var ConnectModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        ...
        React__default['default'].createElement(HelpLink, { href: "https://docs.luckychip.finance/get-started/connection-guide", external: true },
...
exports.LuckyChipIcon = Icon$13;
exports.LuckyChipRoundIcon = Icon$12;
exports.LuckyChipToggle = LuckyChipToggle;
