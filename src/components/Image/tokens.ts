/**
 * @see https://github.com/heswap/heswap-frontend/blob/develop/src/config/constants/tokens.ts
 */
const tokens = {
  cake: {
    symbol: "CAKE",
    ...
    decimals: 18,
    projectLink: "https://luckychip.finance/",
  },
  txl: {
    symbol: "TXL",
    address: {
  ...
  bunny: {
    ...
    decimals: 18,
    projectLink: "https://heswapbunny.finance/",
  },
  alice: {
    symbol: "ALICE",
    address: {
